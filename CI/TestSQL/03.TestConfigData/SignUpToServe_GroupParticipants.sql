...
--Store contact ids
DECLARE @richard_participant_id int;
SET @richard_participant_id = (select Participant_record FROM contacts WITH (NOLOCK) WHERE email_address = 'mpcrds+tremplay.richard@gmail.com'
