...
BEGIN
	...
	DECLARE @invoice_error nvarchar(50);
	EXECUTE [dbo].[cr_QA_New_Invoice] @user_email, @invoice_total, @invoice_date, @product_name,
	@error_message = @invoice_error OUTPUT, @invoice_id = @invoice_id OUTPUT
	...
	DECLARE @payment_error nvarchar(50);
	...
	@error_message = @payment_error OUTPUT, @payment_id = @payment_id OUTPUT;
