...
-- Defines cr_QA_New_Donation_With_DistributionMASTER
IF NOT EXISTS ( SELECT  *
	FROM    sys.objects
	WHERE   object_id = OBJECT_ID(N'cr_QA_New_Donation_With_DistributionMASTER')
			AND type IN ( N'P', N'PC' ) )
	EXEC('CREATE PROCEDURE dbo.cr_QA_New_Donation_With_DistributionMASTER
...
GO
ALTER PROCEDURE [dbo].[cr_QA_New_Donation_With_DistributionMASTER]
	@donor_email nvarchar(254),
	@donation_amount money,
	@donation_date datetime,
	@payment_type_id int,
