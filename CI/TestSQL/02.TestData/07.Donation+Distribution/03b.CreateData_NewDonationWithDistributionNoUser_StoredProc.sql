...
-- Defines cr_QA_New_Donation_With_Distribution_No_User
IF NOT EXISTS ( SELECT  *
	FROM    sys.objects
	WHERE   object_id = OBJECT_ID(N'cr_QA_New_Donation_With_Distribution_No_User')
			AND type IN ( N'P', N'PC' ) )
	EXEC('CREATE PROCEDURE dbo.cr_QA_New_Donation_With_Distribution_No_User
...
GO
ALTER PROCEDURE [dbo].[cr_QA_New_Donation_With_Distribution_No_User]
	@display_name nvarchar(75),
	@is_company bit,
	@contact_email nvarchar(255),
	@donation_amount money,
...
BEGIN
	...
	EXEC [dbo].[cr_QA_New_Donation_No_User] @display_name, @is_company, @contact_email, @donation_amount, @donation_date, @payment_type_id, @donation_status, @receipted, @anonymous,
	...
	EXEC [dbo].[cr_QA_New_Donation_Distribution] @donation_id, @donation_amount, @program_name, @pledge_user_email, @soft_credit_donor_email, @congregation_id, @distribution_notes, 
