...
BEGIN
	...
	SELECT pid as "Participant ID", dn as "Name", gn as "Team", gid as "Group ID", em as "Email", esd as "Last Serve Date", mp as "Mobile Phone" FROM @ServeData WHERE rn=1 AND esd < DATEADD(MONTH, -3, GETDATE()) ORDER BY esd DESC, gn, dn;
END