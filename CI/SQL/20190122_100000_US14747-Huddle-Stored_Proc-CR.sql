...
--UPDATE Groups SET End_Date = GETDATE() Commented out for suggested line below
UPDATE Groups SET End_Date = DATEADD(year, 1, Start_Date)
...
select G.Group_ID, --huddleID
       G.Start_Date, --huddleStart
       G.End_Date, --huddleEnd
       GP.Participant_ID, --participantID
       GP.Start_Date, --participantStart
       GP.End_Date,  --participantEnd
       GP.Group_Role_ID, --huddlerole
       P.Huddle_Status_ID, --currentHuddleStatusId
       0  --newHuddleStatusId
from groups G
...
UPDATE @Huddlers SET newHuddleStatusId = 5 WHERE 
                               ...
                               (huddlerole = 22 ) and
                               (newHuddleStatusId = 0) 
							   and (currentHuddleStatusId != 5)  --Added by Adam, keeps us from continually updating these
