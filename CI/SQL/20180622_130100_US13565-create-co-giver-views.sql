...
AS
    ...
    where 
        ...
        and CONVERT(DATE,COALESCE(cr1.Start_Date, '9999-12-31')) < CONVERT(DATE,COALESCE(cr2.End_Date, '9999-12-31'))
        and CONVERT(DATE, COALESCE(cr1.End_Date, '9999-12-31')) > CONVERT(DATE, COALESCE(cr2.Start_Date, '9999-12-31'))
	UNION
	...
	where cr1.relationship_id = 42
		...
		and (CONVERT(DATE, coalesce(cr1.Start_Date, '9999-12-31')) <> CONVERT(DATE, coalesce(cr2.Start_Date, '9999-12-31')) or CONVERT(DATE, coalesce(cr1.End_Date, '9999-12-31')) <> CONVERT(DATE, coalesce(cr2.End_Date, '9999-12-31')))
	UNION
	...
	from dbo.contact_relationships cr
		join dbo.contacts c1 on cr.contact_id = c1.contact_id
	where cr.relationship_id = 42 and CONVERT(DATE, coalesce(cr.Start_Date, '1990-12-31')) > CONVERT(DATE, coalesce(cr.End_Date, '9999-12-31')) 
	UNION
	...
	from
		dbo.Contacts c1
			...
			left join dbo.Contact_Relationships cr2 on cr2.Contact_ID = c2.Contact_ID and cr2.Relationship_ID = 42 and cr2.Related_Contact_ID = c1.Contact_ID and CONVERT(DATE, coalesce(cr1.Start_Date, '9999-12-31')) = CONVERT(DATE, coalesce(cr2.Start_Date, '9999-12-31'))
	where
