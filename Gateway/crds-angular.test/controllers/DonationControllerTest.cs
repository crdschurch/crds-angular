...
//            _authTokenExpiryService.Setup(a => a.IsAuthtokenCloseToExpiry(It.IsAny<HttpRequestHeaders>())).Returns(true);
//            gatewayDonationServiceMock.Setup(mocked => mocked.GetDonationYearsForDonor(123213)).Returns(dto);
...
//        {
//            _authTokenExpiryService.Setup(a => a.IsAuthtokenCloseToExpiry(It.IsAny<HttpRequestHeaders>())).Returns(true);
//            gatewayDonationServiceMock.Setup(mocked => mocked.GetDonationYearsForDonor(123213)).Returns((DonationYearsDTO)null);
//            var response = fixture.GetDonationYears();
//            gatewayDonationServiceMock.VerifyAll();
