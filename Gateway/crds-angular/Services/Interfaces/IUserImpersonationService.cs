...
namespace crds_angular.Services.Interfaces
{
    ...
    public interface IUserImpersonationService
    {
        ...
        /// <param name="usernameToImpersonate">The user id of the user to impersonate, typically the user's email address.</param>
        /// <param name="action">The action to run as the impersonated user</param>
        /// <returns>The output of the 'action' function</returns>
        TOutput WithImpersonation<TOutput>(AuthDTO authDTO, string usernameToImpersonate, Func<TOutput> action);
        ...
        /// <param name="action">The action to run as the impersonated user</param>
        /// <returns>The output of the 'action' function</returns>
        TOutput WithImpersonation<TOutput>(string accessToken, string usernameToImpersonate, Func<TOutput> action);
    }
}
